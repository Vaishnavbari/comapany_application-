...
class CompanyProviderServiceCategorySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        check_company = CheckCompanyAccess(company_name=company_name)
        ...
        company_providers, is_created =  company_provider_service_category.objects.get_or_create(
...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        user_access = CheckCompanyAccess(user_id=user.id, company_id=company_id.id)
